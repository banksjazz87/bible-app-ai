...
export default function BibleForm({submitHandler, updateNeededChapter}: BibleFormProps): JSX.Element {
    ...
    useEffect((): void => {
        setBibleForm({
            ...
            testament: returnSearchParamValues("testament"),
            book: bibleForm.testament === 'Old' ? returnSearchParamValues("book") : returnSearchParamValues("book"),
                ...
                <form onSubmit={(e) => submitHandler(e)}>
                    <div className="grid grid-flow-col grid-columns-3 gap-4">
                        ...
                        <Options
                            ...
                            selectedValue={getSelectTextValue("testament", TestamentOptions)}
                        />
                        ...
                        {bibleForm.testament === "old" && (
                            <Books
                                ...
                                optionsID="book"
                                placeholder="Book"
                                selectedValue={getSelectTextValue("book", OldTestamentBooks)}
                            />
                        )}
                        ...
                        {bibleForm.testament === "new" && (
                            <Books
                                ...
                                optionsID="book"
                                placeholder="Book"
                                selectedValue={getSelectTextValue("book", NewTestamentBooks)}
                            />
                        )}
